...
[Q('下列何種激素的受體具有內建的 Tyrosine Kinase 活性，且在結合配體後會發生二聚體化並啟動自體磷酸化？',['Growth Hormone','Insulin','Prolactin','Epinephrine'],1,'RTK 的受體本身即具有酵素活性，典型代表為 Insulin 與 IGF-1。當配體結合後，受體發生 Dimerization 並進行 Autophosphorylation，啟動下游訊號。'),
Q('關於「受體酪氨酸激酶相關受體」(Tyrosine Kinase-associated Receptors) 的敘述，下列何者正確？',['受體本身即具有激酶活性','受體須與細胞質內的酵素（如 JAK）連結','主要是透過 G 蛋白傳遞訊號','為類固醇激素的主要作用途徑'],1,'第二類酵素相關受體（如 GH 與 Prolactin 受體）本身不具活性，特徵是與細胞質內其他酵素連結（如 JAK），進而觸發 JAK-STAT 路徑。'),
Q('下列哪一組激素的信號傳遞機制主要是透過 JAK-STAT 路徑進行調控？',['Insulin, IGF-1','Epinephrine, Norepinephrine','Growth Hormone, Prolactin','Cortisol, Aldosterone'],2,'Growth Hormone (GH) 與 Prolactin 的受體屬於與細胞質內酵素連結的類型，使用 JAK-STAT 路徑進行信號傳遞。'),
Q('關於類固醇激素與甲狀腺素的受體作用機制，下列敘述何者正確？',['藉由開啟離子通道產生動作電位','透過第二信使 cAMP 活化蛋白質激酶','具親脂性可擴散通過細胞膜，進行基因調控','僅與細胞膜上的 RTK 受體結合'],2,'類固醇激素與甲狀腺素因具親脂性 (Lipophilic)，可擴散通過細胞膜，與核內或胞質受體結合後調控基因表達。'),
Q('在受體信號傳遞中，受體發生「Dimerization」（二聚體化）最常見於下列哪種機制？',['離子通道型受體','受體酪氨酸激酶 (RTK)','類固醇受體','乙醯膽鹼菸鹼型受體'],1,'在 RTK 機制中（如 Insulin），受體單體結合配體後發生 Dimerization，隨後進行自體磷酸化以啟動後續反應。')],
[Q('下列何者不屬於 Receptor Tyrosine Kinase (RTK) 的典型配體？',['Insulin','IGF-1','Growth Factor','Prolactin'],3,'Insulin 與 IGF-1 歸類於「受體本身即有激酶活性」的 RTK；Prolactin 則歸類於「受體與胞內酵素連結」的類型，不具內建激酶活性。'),
Q('關於信號傳遞路徑中「Autophosphorylation」的意義，下列敘述何者正確？',['受體在沒有配體結合時自發產生的現象','RTK 受體二聚體化後，胞內區段彼此磷酸化對方的酪氨酸殘基','是類固醇受體進入細胞核的必要物理步驟','由 JAK 酵素直接對受體進行的初步磷酸化'],1,'Autophosphorylation 發生在 RTK 結合配體並進行二聚體化之後，兩個受體的胞內激酶區段互相磷酸化，是啟動後續傳遞鏈的關鍵步驟。'),
Q('Growth Hormone 結合其受體後，最先活化的細胞質相關酵素為何？',['Adenylate Cyclase','Tyrosine Kinase (in-built)','JAK (Janus Kinase)','Phospholipase C'],2,'Growth Hormone 的受體需與細胞質內酵素連結，其連結酵素為 JAK（Janus Kinase），進而啟動 JAK-STAT 路徑。'),
Q('下列關於激素受體位置的敘述，何者錯誤？',['Insulin 的受體位於細胞膜上','Growth Hormone 的受體位於細胞膜上','Thyroid Hormone 的受體位於細胞核內或與基因調控相關','Prolactin 的受體位於細胞核內'],3,'Prolactin 的受體屬於與細胞質酵素連結的膜受體（Membrane receptor），並非核受體。僅類固醇與甲狀腺素被標註為核/胞質受體。'),
Q('在 JAK-STAT 路徑中，「STAT」分子的主要功能為何？',['作為受體磷酸化的催化酶','作為轉錄因子進入細胞核調控基因表達','分解第二信使以終止信號','開啟細胞膜上的鈉離子通道以產生電位'],1,'JAK 活化後磷酸化 STAT，受磷酸化的 STAT 二聚化後進入細胞核發揮基因調控作用。')],
[Q('下列何種激素的作用機制不涉及直接的基因轉錄調控？',['Cortisol','Estrogen','Epinephrine','Thyroxine (T4)'],2,'類固醇（如 Cortisol, Estrogen）與甲狀腺素（T4）與基因調控受體相關；Epinephrine 則通常透過細胞膜受體與第二信使系統作用，反應較快但不直接調控轉錄。'),
Q('關於 Insulin 受體結構的描述，下列何者正確？',['為單次跨膜受體且不具酵素活性','具有內建的酪氨酸激酶 (Tyrosine Kinase) 活性','必須透過 G 蛋白才能啟動胞內訊息','其配體結合位點位於細胞質內'],1,'Insulin 受體本身即含有 Tyrosine Kinase，屬於 RTK 家族。配體結合位點在胞外，激酶活性位點在胞內。'),
Q('IGF-1 的信號傳遞與下列何種激素的作用機制最為相似？',['Glucagon','Insulin','Epinephrine','Parathyroid Hormone'],1,'Insulin 與 IGF-1 被歸類在同一機制下，即具有內建激酶活性的受體 (Tyrosine Kinase-containing Receptors)，均可引發 Dimerization 與 Autophosphorylation。'),
Q('類固醇激素之所以能通過細胞膜進入細胞，主要是因為其具有何種性質？',['極高的水溶性','高親脂性 (Lipophilic)','帶有大量負電荷','分子量大於蛋白質'],1,'類固醇與甲狀腺素因具親脂性，可直接擴散通過磷脂質雙層細胞膜，到達胞質或胞核內的受體。'),
Q('在 RTK 的活化過程中，ATP 分子的主要功能為何？',['作為受體結合的配體','提供磷酸根以進行受體的自體磷酸化','協助受體在膜上移動','穩定受體的二聚體結構'],1,'自體磷酸化 (Autophosphorylation) 過程需要 ATP 提供磷酸根，這是 Kinase 活性的基本生化反應。')],
[Q('下列何者是 Growth Hormone 傳遞訊息的主要特徵？',['受體本身具有內建激酶活性','受體與 JAK 酵素連結','透過 cGMP 路徑開啟通道','受體與配體結合後直接轉運至細胞核'],1,'GH 與 Prolactin 被歸類於受體與「細胞質內其他酵素連結」（如 JAK）的機制，屬於 Tyrosine Kinase-associated 類型。'),
Q('關於「基因調控相關」受體配體的敘述，下列何者正確？',['反應速度比 RTK 快','受體僅分布於細胞膜表面','配體包含 Steroid Hormone 與 Thyroid Hormone','主要透過活化 Adenylate Cyclase 產生作用'],2,'基因調控相關受體的典型配體為 Steroid Hormone 與 Thyroid Hormone，兩者均具親脂性可入胞調控基因。'),
Q('當 Insulin 與受體結合後，受體胞內區段的何種氨基酸殘基會被磷酸化？',['Serine','Threonine','Tyrosine','Histidine'],2,'該受體名稱為「酪氨酸」激酶受體 (Receptor Tyrosine Kinase)，磷酸化是發生在 Tyrosine（酪氨酸）殘基上。'),
Q('下列何種受體不具備內建激酶活性，但能活化胞內的非受體激酶（如 JAK）？',['Insulin Receptor','IGF-1 Receptor','Prolactin Receptor','EGF Receptor'],2,'Prolactin 受體屬於 Tyrosine Kinase-associated 型，需與胞內酵素 JAK 連結，受體本身不具激酶活性。'),
Q('激素信號傳遞中，「Dimerization」的主要生理目的是什麼？',['增加受體對激素的親和力','促使受體胞內區段相互靠近以進行磷酸化反應','協助受體經由胞吞作用降解','阻斷其他激素的結合'],1,'在 RTK 機制中，Dimerization 使兩個受體單體的激酶區段相互接觸並彼此磷酸化，是 RTK 活化的核心步驟。')]
)},
{id:"p7",title:"國考預測題型 第七波",em:"🪐",c:"#EF4444",u:u4(
[Q('在肝臟解剖結構中，所謂的「Classic lobule」（典型小葉）之中心構造為何？',['Portal area','Bile duct','Central vein','Hepatic artery'],2,'Classic lobule 的幾何中心位置為 Central vein（中央靜脈），肝細胞索呈放射狀由外周向中心排列。'),
Q('肝臟的「Portal area」（肝門區）通常包含下列哪三種構造？',['中央靜脈、肝動脈、門靜脈','肝動脈、門靜脈、膽管','中央靜脈、肝索、肝竇','膽小管、淋巴管、肝靜脈'],1,'Portal area 位於小葉的邊角 (Corners)，包含肝動脈、門靜脈及膽管分支（門脈三體，Portal triad）。'),
Q('下列何者不屬於肝臟的主要「製造」（Synthesis）功能？',['Albumin（白蛋白）','Clotting factors（凝血因子）','Insulin（胰島素）','Bile（膽汁）'],2,'肝臟負責製造白蛋白、凝血因子及膽汁。胰島素是由胰臟的胰島細胞分泌，而非肝臟。'),
Q('肝臟在「代謝」(Metabolism) 功能中，如何協助調節血糖穩定？',['透過製造紅血球增加氧氣運送','透過糖質新生 (Gluconeogenesis) 與肝糖儲存','透過分泌胃酸協助消化','透過直接分解蛋白質產生能量'],1,'肝臟具有 Gluconeogenesis（糖質新生）與肝糖的合成/分解功能，是維持血糖恆定的核心器官。'),
Q('肝臟的「Excretion」（排泄）功能主要體現在下列何種物質的處理？',['尿素','膽紅素 (Bilirubin) 隨膽汁排出','呼出二氧化碳','分泌皮脂'],1,'肝功能包含製造與排泄膽汁，膽汁中含有代謝廢物如膽紅素，由肝細胞排入膽道系統。')],
[Q('關於肝臟內血流與膽汁流動方向的敘述，下列何者正確？',['血流由中央靜脈流向門脈區','血流由門脈區流向中央靜脈（Centripetal），膽汁則由中心流向門脈區（Centrifugal）','血流與膽汁流動的方向完全相同','肝臟僅接受來自門靜脈的單一血液供應'],1,'在肝小葉中，血液由外周門脈區流向中心中央靜脈（Centripetal）；膽汁由肝細胞分泌後往外流向門脈區膽管（Centrifugal）。'),
Q('肝臟小葉結構中，執行血液與肝細胞間物質交換的主要場所為何？',['Central vein','Hepatic Sinusoids（肝竇）','Bile canaliculi（膽小管）','Portal vein'],1,'肝細胞排列成索狀，中間微細的血流空隙即為肝竇 (Sinusoids)，是血液與肝細胞進行物質交換的關鍵微環境。'),
Q('下列何種維生素的儲存與肝臟功能直接相關？',['Vitamin A, D, B12','Vitamin C','所有水溶性維生素','僅 Vitamin K'],0,'肝臟是人體重要的儲存器官，可儲存脂溶性維生素 (A, D, E, K) 及 Vitamin B12。'),
Q('肝臟製造的白蛋白 (Albumin) 對於循環系統的主要貢獻為何？',['專司攜帶氧氣','維持血漿膠體滲透壓','誘發發炎反應','作為主要凝血底物'],1,'白蛋白由肝臟合成，是血漿中含量最多的蛋白質，負責維持血漿膠體滲透壓，防止水腫。'),
Q('肝臟如何代謝體內產生的有毒氨 (Ammonia)？',['直接由膽小管排入腸道','轉化為尿素 (Urea)','轉化為氨基酸重新利用','儲存在中央靜脈中待腎臟過濾'],1,'肝臟能將具毒性的氨經由尿素循環 (Urea cycle) 轉化為低毒性的尿素，再由腎臟排出體外。')],
[Q('Classic lobule 在橫切面上通常呈現何種幾何形狀？',['圓形','六角形 (Hexagonal)','橢圓形','不規則形'],1,'肝小葉示意圖清楚顯示 Classic lobule 呈現典型的六角形結構，中央靜脈位於中心，門脈三體位於頂角。'),
Q('肝臟合成的膽鹽 (Bile salts) 主要功能為何？',['幫助碳水化合物吸收','乳化脂肪，促進其消化與吸收','殺死腸道細菌','降低胃酸鹼度'],1,'肝臟製造膽汁中的膽鹽，可乳化脂肪，增加脂肪酶的作用面積，促進小腸吸收脂溶性物質。'),
Q('下列哪項功能不屬於肝臟的生理職責？',['藥物去毒作用 (Detoxification)','合成凝血因子','作為成人促紅血球生成素 (EPO) 的主要製造地','儲存肝糖與脂質'],2,'促紅血球生成素 (EPO) 主要由成人的腎臟製造。肝臟具備合成、代謝、排泄等功能，但非成人 EPO 主要來源（胎兒期由肝臟製造）。'),
Q('在肝小葉結構圖中，Portal area（門脈區）位於何處？',['六角形的中心','六角形的頂角 (Corners)','緊鄰中央靜脈','散佈於肝索內部'],1,'Portal area 位於 Classic lobule 六角形的頂角位置，每個小葉有六個頂角，各含一組門脈三體。'),
Q('若患者出現凝血時間延長且伴隨血漿白蛋白降低，最可能是何種器官受損？',['腎臟','肝臟','脾臟','肺臟'],1,'白蛋白與凝血因子均由肝臟製造，上述症狀同時出現反映了肝臟合成功能的受損。')],
[Q('下列何種物質會阻斷運動神經末梢的「Voltage-sensitive Na+ 通道」，進而抑制動作電位的傳導？',['Botox','Curare','TTX（河豚毒素）','Neostigmine'],2,'TTX (Tetrodotoxin) 的機制是阻斷 Voltage sensitive Na+ 通道，使神經與肌肉無法產生動作電位，最終導致呼吸肌麻痺。'),
Q('肉毒桿菌毒素 (Botulinus toxin, Botox) 造成肌肉麻痺的機制為何？',['阻斷鈉離子流入肌肉細胞','抑制神經末梢釋放乙醯膽鹼 (ACh)','競爭性結合菸鹼型受體','促進乙醯膽鹼快速分解'],1,'Botox 的作用機制是「抑制節前神經釋放 Ach」，干擾 SNARE 蛋白導致胞吐作用無法進行，使信號無法傳遞至肌肉。'),
Q('南美箭毒 (Curare) 如何影響神經肌肉接合處 (NMJ)？',['增加 ACh 的合成量','與 ACh 競爭肌肉上的 Nicotinic Receptor，減少 EPP 大小','抑制乙醯膽鹼酯酶','阻斷肌肉細胞膜上的鉀離子通道'],1,'Curare 的機制是「與 Ach 競爭肌肉的 Ach 受器」，導致終板電位 (EPP) 減小，不足以激發動作電位。'),
Q('重症肌無力 (Myasthenia gravis) 的主要生理機制為何？',['運動神經元退化','產生自體抗體破壞 ACh 的 Nicotinic Receptor','鈣離子無法進入神經末梢','鈉離子通道先天性缺失'],1,'Myasthenia gravis 是由「自體抗體對抗乙醯膽鹼受體（Nicotinic Receptor）」，導致受體數量減少，肌肉收縮無力。'),
Q('Neostigmine 用於治療重症肌無力，其作用機制為何？',['直接活化 ACh 受體','抑制乙醯膽鹼酯酶 (AChE) 活性','增加神經末梢 ACh 的釋放頻率','阻斷鈣離子外流'],1,'Neostigmine 抑制 Acetylcholinesterase，減少 ACh 的分解，藉此增加突觸間隙 ACh 濃度，補償受體數量的不足。')]
)},
{id:"p8",title:"國考預測題型 第八波",em:"🌌",c:"#3B82F6",u:u4(
[Q('根據肌肉比較表，骨骼肌與心肌的動作電位長度有何顯著差異？',['骨骼肌（1 ms）遠短於心肌（250-300 ms）','心肌（10 ms）短於骨骼肌（100 ms）','兩者均為 1 ms','平滑肌最長，達 1000 ms'],0,'骨骼肌動作電位長度僅約 1 ms，心肌則長達 250-300 ms，心肌 AP 特別長是為了防止心臟發生強直收縮。'),
Q('心肌動作電位出現長時間「平台期」(Plateau) 的離子基礎為何？',['鈉離子流入與鉀離子流出的平衡','鈣離子經由 L-type 通道流入與鉀離子流出的平衡','氯離子流出與鈉離子流入的平衡','僅由大量鈉離子持續流入造成'],1,'心肌在再極化過程中，K+ 流出的同時有 Ca2+ 經由 L-type 通道流入，這抵銷了部分再極化電位，導致電位停滯在接近 0 mV，形成平台期。'),
Q('平滑肌收縮時，胞內鈣離子主要與下列何種蛋白質結合？',['Troponin C','Calmodulin（鈣調蛋白）','Tropomyosin','Myosin light chain'],1,'平滑肌的鈣離子是與 Calmodulin 結合，形成 Ca-CaM 複合物後活化 MLCK（Myosin light chain kinase）。'),
Q('骨骼肌收縮所需的鈣離子，其主要的來源機制為何？',['由細胞外液 (ECF) 直接流入','動作電位經由橫小管 (T-tubules) 傳導，誘發 SR 釋放鈣','經由鈉鈣交換蛋白移入','由粒線體直接釋放'],1,'骨骼肌動作電位藉由橫小管 (T-tubules) 導入，進而誘發肌漿網 (SR) 的 RyR1 通道開啟，釋放 Ca2+。'),
Q('關於平滑肌鈣離子的來源，下列敘述何者正確？',['完全來自發達的肌漿網','包含細胞外流入（經由膜上的 Voltage-gated 鈣通道）','平滑肌收縮不需要細胞外鈣離子','僅來自細胞質內的蛋白分解'],1,'平滑肌鈣離子來源包含細胞外（經由 Voltage-gated 鈣通道流入）及肌漿網釋放（不如骨骼肌發達）兩部分。')],
[Q('心肌收縮的「鈣離子誘導鈣離子釋放」(CICR) 機制為何？',['SR 釋放鈣誘導細胞外鈣流入','細胞外鈣流入後，誘發 SR 釋出更多鈣','鈉離子流入誘導 SR 釋放鈣','鉀離子流出誘導鈣結合'],1,'心肌的 CICR：L-type Ca 通道開啟使少量 Ca2+ 流入，觸發 SR 上的 RyR2 大量釋放 Ca2+。'),
Q('下列何種肌肉構造特徵包含「閏板」(Intercalated disk)？',['骨骼肌','平滑肌','心肌','所有的橫紋肌'],2,'僅有心肌 (Cardiac muscle) 具有 Intercalated disk（閏板），含有 Gap junction 與 Desmosome，確保心肌的電性耦合與機械連結。'),
Q('骨骼肌細胞（肌纖維）的細胞核特徵為何？',['單核且位於中央','多核且位於纖維邊緣','無核細胞','多核且位於纖維正中心'],1,'骨骼肌肌纖維由多個肌母細胞融合而成，因此是多核細胞，細胞核分布在纖維的邊緣（周邊位置）。'),
Q('平滑肌收縮的最終活化步驟涉及下列何者？',['Troponin-Tropomyosin 位移','Myosin 輕鏈的磷酸化 (Phosphorylation)','橫小管的快速去極化','鈣離子與肌動蛋白直接結合'],1,'平滑肌 Ca-CaM 複合物活化 MLCK，使 Myosin 輕鏈磷酸化後方能與 Actin 結合收縮，這是平滑肌收縮的關鍵步驟。'),
Q('骨骼肌收縮時，鈣離子是與下列何種感應蛋白結合？',['Calmodulin','Troponin C','Myosin light chain kinase','Collagen'],1,'骨骼肌的鈣離子是與 Troponin C 結合，引起 Troponin 複合物構型改變，使 Tropomyosin 移開，暴露 Actin 的 Myosin 結合位點。')],
[Q('下列哪種肌肉的動作電位與收縮時間高度重疊，使其不反應期極長？',['骨骼肌','平滑肌','心肌','所有的多核肌肉'],2,'心肌的動作電位長達 250-300 ms，與其收縮曲線大部分重疊，使心肌不反應期極長，具有防止強直收縮的重要生理意義。'),
Q('平滑肌的靜止膜電位 (Resting membrane potential) 約為多少 mV？',['−90 mV','−70 mV','−50 mV','−30 mV'],2,'根據肌肉電生理參數表，平滑肌的靜止膜電位為 −50 mV，而骨骼肌與心肌則為 −90 mV。'),
Q('在 NMJ 處，乙醯膽鹼 (ACh) 結合的受體類型主要是？',['M-受體 (Muscarinic)','N-受體 (Nicotinic)','Alpha-受體','Beta-受體'],1,'NMJ 運動終板主要含有 Nicotinic receptor（nAChR），這是重症肌無力自體抗體的攻擊目標。'),
Q('關於 EPP (End plate potential) 的敘述，下列何者正確？',['是發生在神經末梢的動作電位','是發生在肌肉運動終板的局部電位，會受 Curare 影響減小','是一種全有或全無 (All-or-none) 的電位變化','是由鉀離子流入引起的'],1,'EPP 是 ACh 作用於終板受體產生的級距電位（局部電位），Curare 競爭性阻斷受體後，EPP 振幅減小。'),
Q('TTX（河豚毒素）中毒導致死亡的主要生理原因是？',['心律不整','骨骼肌（含呼吸肌）無法產生動作電位導致麻痺','腦部過度興奮','血管劇烈收縮'],1,'TTX 阻斷鈉通道，使神經與肌肉無法產生動作電位，最終導致呼吸肌麻痺，因呼吸衰竭死亡。')],
[Q('下列哪種肌肉的收縮調節機制中不包含 Troponin？',['骨骼肌','心肌','平滑肌','以上皆含'],2,'平滑肌使用 Calmodulin 與 Myosin 磷酸化路徑，其收縮蛋白中不含 Troponin C，與骨骼肌和心肌不同。'),
Q('心肌動作電位的「平台期」對心臟功能的保護意義為何？',['加快心跳速度','確保心肌有足夠時間舒張，防止發生強直收縮 (Tetanus)','減少氧氣消耗','增加電傳導速度'],1,'心肌長動作電位導致長不反應期，使其無法像骨骼肌那樣發生強直收縮，確保心臟能節律性收縮與舒張。'),
Q('關於平滑肌與心肌結構特徵的比較，下列何者正確？',['兩者均具有橫紋','平滑肌單核位於中央，心肌亦為單核（或雙核）位於中央','平滑肌具有橫小管，心肌則無','兩者均具有多個邊緣核'],1,'平滑肌單核位於中央且無橫紋；心肌亦多為單核位於中央且有橫紋，兩者在核的位置特徵上相同。'),
Q('神經肌肉訊息傳遞中，ACh 通過接合隙後，在肌肉細胞膜引發的主要離子流動為何？',['鉀離子流入','鈉離子流入 (Na+ influx)','鈣離子流出','氯離子流入'],1,'nAChR 是非選擇性陽離子通道，開啟後主要引起 Na+ 大量流入，造成終板去極化，進而啟動動作電位。'),
Q('某藥物作用於受體，其結果為「減少 EPP 的大小」，此藥物最可能是？',['TTX','Botox','Curare','Neostigmine'],2,'Curare 的機制是競爭性阻斷 ACh 受體，導致產生的終板電位 (EPP) 振幅下降，低於閾值則無法引發 AP。')]
)},
{id:"p9",title:"國考預測題型 第九波",em:"✨",c:"#84CC16",u:u4(
[Q('骨骼肌中，動作電位傳導至深部引發鈣釋放的結構是？',['肌小節 (Sarcomere)','橫小管 (T-tubules)','細胞核','閏板'],1,'骨骼肌動作電位藉由橫小管 (T-tubules) 導入細胞內部，電訊號透過 T-tubule 傳至 SR，誘發鈣離子釋放。'),
Q('肌肉放鬆時，胞質內的鈣離子主要透過何種構造回到肌漿網 (SR)？',['Ca2+ ATPase（鈣離子泵）','簡單擴散','鈉鈣交換蛋白','橫小管'],0,'肌肉放鬆需要主動將鈣離子泵回 SR 內，此過程由 SR 膜上的 SERCA（Ca2+ ATPase）完成，消耗 ATP。'),
Q('重症肌無力患者最典型的臨床特徵為何？',['肌肉永久僵硬','肌肉無力且在重複活動後症狀加重','觸覺喪失','動作電位頻率過快'],1,'由於受體數量不足，重複運動會消耗 ACh 的效力，導致「肌無力」症狀在活動後加劇，休息後可稍為恢復。'),
Q('平滑肌收縮反應較骨骼肌慢，主要與下列哪一項有關？',['缺乏鈣離子','需經由酵素磷酸化反應的化學路徑','動作電位太短','缺乏 Actin 絲'],1,'平滑肌收縮涉及 Calmodulin 結合 → MLCK 活化 → Myosin 磷酸化的化學路徑，此生化過程較骨骼肌的物理位移（Troponin 移位）慢。'),
Q('關於三種肌肉靜止膜電位的比較，下列何者正確？',['骨骼肌比平滑肌更負（−90 vs −50 mV）','三者皆為 −70 mV','平滑肌最負（−110 mV）','心肌電位最正'],0,'骨骼肌與心肌為 −90 mV，平滑肌為 −50 mV。骨骼肌的靜止膜電位比平滑肌更負。')],
[Q('腸胃道的「慢波」(Slow waves) 是由下列何種細胞產生的？',['肌肉細胞','Cajal Cell（卡哈爾細胞）','迷走神經細胞','黏膜上皮細胞'],1,'Cajal Cell 是產生腸胃道慢波的起搏細胞（Pacemaker cells），位於腸壁神經叢與肌肉層附近。'),
Q('關於腸胃道慢波 (Slow waves) 的敘述，下列何者正確？',['慢波本身即是動作電位','其頻率決定了該部位收縮的最大可能頻率','慢波一定會引發肌肉收縮','慢波頻率在小腸末端最高'],1,'慢波是靜止膜電位的節律性波動，其頻率決定了該段消化道產生收縮的最大潛在節律，但不一定引發收縮。'),
Q('「Auerbach Plexus」（奧氏神經叢）又常被稱為？',['Submucosal Plexus','Myenteric Plexus（肌間神經叢）','Celiac Plexus','Solar Plexus'],1,'Auerbach Plexus 等於 Myenteric Plexus，位於腸壁兩層平滑肌之間，主要控制 GI 運動。'),
Q('Auerbach Plexus 在腸壁層次中的精確位置為何？',['黏膜下層','位於環肌層 (Circular muscle) 與縱肌層 (Longitudinal muscle) 之間','漿膜層外側','緊鄰黏膜上皮'],1,'Auerbach Plexus 位於兩層平滑肌（環肌與縱肌）之間，主控 GI Motility（運動功能）。'),
Q('腸胃道的內源性神經系統中，主要負責控制腺體分泌與局部血流量的是？',['Auerbach Plexus','Meissner Plexus（Submucosal Plexus）','Vagus nerve','Sympathetic ganglion'],1,'Meissner Plexus 位於黏膜下層，主要調節腺體分泌與局部血流；Auerbach Plexus 則負責蠕動控制。')],
[Q('小腸最主要的運動方式以利於混合食糜與消化液的是？',['Mass movement','Segmentation（分節式收縮）','Peristalsis','Vomiting'],1,'分節式收縮 (Segmentation) 是小腸非推進性的主要混合運動，透過局部環肌交替收縮混合食糜並增加與黏膜接觸面積。'),
Q('大腸出現的特有大規模推進運動稱為？',['Segmentation','Mass movement（大集團蠕動）','Slow wave oscillation','Retrograde peristalsis'],1,'大腸的 Mass movement 常在進食後因胃結腸反射誘發，能一次將內容物推向遠端結腸。'),
Q('胃的排空 (Gastric emptying) 受下列何種機制調節？',['僅受交感神經控制','受神經（如 Enterogastric reflex）與激素共同調節','僅受胃泌素影響','僅受慢波頻率控制'],1,'胃的排空受多重反饋機制調節，包含神經反射（如 Enterogastric reflex）與十二指腸分泌的激素（Secretin, CCK）。'),
Q('關於 Cajal Cells 的生理功能，下列敘述何者錯誤？',['屬於腸胃道的起搏器','位於腸壁的神經叢與肌肉層附近','負責吸收腸道內的葡萄糖','負責產生慢波電位'],2,'Cajal Cells 是「起搏細胞」，負責產生節律電位；它們不具備營養吸收功能，吸收是由小腸絨毛上皮細胞負責。'),
Q('副交感神經刺激腸胃道時，其主要生理效應為何？',['抑制所有蠕動','促進蠕動與分泌功能','收縮所有括約肌','減少局部血液供應'],1,'副交感神經系統（如迷走神經）是腸胃道功能的促進者，增加運動與分泌，與交感神經的抑制作用相對。')],
[Q('交感神經對腸胃道活動的典型影響是？',['增加慢波的振幅','抑制平滑肌蠕動並使括約肌收縮','促進膽紅素排泄','縮短胃排空時間'],1,'交感神經主要扮演抑制角色，減少腸道動力並使括約肌收縮，是「戰鬥或逃跑」反應的一部分。'),
Q('關於腸胃道慢波與尖峰電位 (Spike potentials) 的關係，何者正確？',['慢波本身就是強烈收縮的訊號','當慢波去極化超過閾值並產生尖峰電位時，才會引起顯著收縮','尖峰電位由氯離子流出引起','慢波頻率越高，尖峰電位越弱'],1,'慢波是節律性背景電位，必須在其頂端產生尖峰電位（動作電位）才會引發肌肉收縮；神經傳導物質與激素可調控此過程。'),
Q('小腸各段中，慢波頻率最高的地方是？',['十二指腸 (Duodenum)','空腸 (Jejunum)','迴腸 (Ileum)','迴盲瓣'],0,'小腸的慢波頻率呈現由近端到遠端遞減的趨勢，十二指腸最高（約 12 次/分），迴腸最低（約 8 次/分）。'),
Q('進食後引發「胃結腸反射」(Gastrocolic reflex) 的主要表現是？',['胃壁劇烈收縮','誘發大腸的大規模推進運動 (Mass movement)','抑制胃酸分泌','促進唾液分泌'],1,'胃結腸反射指的是胃擴張訊息誘發大腸蠕動，這是餐後易產生便意的生理基礎。'),
Q('若腸道內神經叢（Auerbach Plexus）功能喪失，會造成？',['腸道運動功能障礙（如內容物滯留）','胃酸過度分泌','膽紅素合成增加','脂肪吸收加快'],0,'Auerbach Plexus 主控蠕動，若缺失將導致腸道失去動力（如 Hirschsprung disease 巨結腸症），產生腸阻塞。')]
)},
{id:"p10",title:"國考預測題型 第十波",em:"👁️",c:"#F59E0B",u:u4(
[Q('關於小腸「分節收縮」(Segmentation) 的目的，敘述正確的是？',['快速將食物排空至大腸','混合食物與消化酶，增加與黏膜接觸面積以利吸收','僅為了防止食物逆流','由交感神經直接啟動'],1,'分節收縮是非推進性的，其目的是充分攪拌食糜並增加與黏膜的接觸時間，以利消化吸收。'),
Q('腸胃道的長反射 (Long reflex) 是指訊息傳至下列何處後發出的反射？',['腸壁神經叢','中樞神經系統 (CNS)','鄰近的小腸節段','肝臟'],1,'長反射涉及中樞神經（如迷走神經），而短反射則侷限於腸壁內神經系統 (ENS) 本身。'),
Q('迷走神經在胃部的生理作用不包括？',['增加胃酸分泌','增加胃蛋白酶原分泌','引起胃部的容受性舒張 (Receptive relaxation)','抑制胃壁肌肉收縮'],3,'迷走神經在進食期整體上是促進胃的分泌與收縮動力，不具有抑制胃壁肌肉收縮的作用。'),
Q('腸壁內源性神經系統中，負責感知化學變化與拉伸的是？',['只有運動神經元','感覺神經元','只有間質細胞','所有的紅血球'],1,'ENS 內含感覺神經元，能偵測管腔內的酸鹼度、滲透壓及物理拉伸，協調整合 ENS 的反射。'),
Q('何種激素被稱為腸道的「清道夫」，能啟動移行性複合運動 (MMC)？',['Motilin（動胃素）','Secretin','Gastrin','CCK'],0,'Motilin 在空腹期分泌，負責啟動移行性複合運動 (Migrating Motor Complex, MMC) 以清理消化道內殘餘內容物。')],
[Q('氧合血紅素解離曲線 (O2-Hb dissociation curve) 向右移位 (Right shift) 的生理意義是？',['Hb 對氧親和力增加','Hb 較容易將氧氣釋放給組織','肺部氧氣結合效率提升','血紅素與一氧化碳結合'],1,'曲線右移代表 Hb 與氧的親和力下降，有利於氧氣在組織端解離（P50 增大），確保代謝旺盛組織獲得充足氧氣。'),
Q('下列哪些因素會導致氧合血紅素解離曲線「向右移位」？',['pH 值上升、溫度下降','2,3-DPG 濃度增加、pH 值下降、運動','二氧化碳濃度降低','胎兒血紅素取代成人血紅素'],1,'DPG 增加、pH 下降（酸中毒）、溫度上升與 CO2 增加均使曲線右移（Bohr effect）。'),
Q('劇烈運動時，肌肉附近的微環境會如何影響氧氣的供給？',['產生酸與熱，促使曲線左移','產生 CO2、熱量與酸，促使曲線右移以利釋放氧氣','減少 2,3-DPG 產量','增加血紅素與氧的親和力'],1,'運動產生的代謝產物（CO2、乳酸）與熱能使曲線右移（Bohr effect），確保工作中的肌肉獲得更多氧氣。'),
Q('氧合血紅素解離曲線「向左移位」的原因包括？',['體溫上升','血中 CO2 濃度降低、體溫降低、2,3-DPG 減少','酸中毒','氧氣分壓急劇下降'],1,'向左移位（Hb 緊抓氧氣）的因素：降低 CO2、降低體溫、降低 DPG、pH 上升（鹼中毒）。'),
Q('關於 2,3-DPG (2,3-diphosphoglycerate) 的敘述，正確的是？',['會導致曲線左移','高海拔居住者體內含量會增加，利於氧氣釋放','由神經細胞分泌','增加 Hb 對氧的親和力'],1,'高海拔環境缺氧，紅血球產生更多 2,3-DPG 使曲線右移，協助組織在低 PO2 環境下仍能獲得足夠氧氣。')],
[Q('胎兒血紅素 (HbF) 對氧的親和力較成人 (HbA) 高，其曲線位置為何？',['位於 HbA 曲線的左側','位於 HbA 曲線的右側','與 HbA 完全重疊','是一條垂直線'],0,'HbF 親和力高（曲線左移），確保胎兒能在胎盤交換時從母體 HbA 有效奪取氧氣，維持胎兒的氧供。'),
Q('自主神經系統中，Epinephrine (Epi) 主要由下列何種酵素催化代謝？',['Acetylcholinesterase','MAO（Monoamine oxidase）','Tyrosine hydroxylase','COMT'],1,'Epinephrine 由 MAO（單胺氧化酶）催化代謝，這是兒茶酚胺代謝的重要路徑之一。'),
Q('Norepinephrine (NE) 的代謝與回收主要涉及下列何種酵素？',['COMT (Catechol-O-methyltransferase)','Carbonic anhydrase','DNA Polymerase','MAO'],0,'NE 由 COMT（兒茶酚-O-甲基轉移酶）催化代謝回收，這是與 Epinephrine 的代謝酵素不同之處。'),
Q('關於兒茶酚胺回收酵素的配對，根據講義敘述何者正確？',['NE – MAO；Epi – COMT','NE – COMT；Epi – MAO','兩者均僅由 MAO 回收','兩者均僅由 COMT 回收'],1,'NE 由 COMT 催化回收，Epinephrine 由 MAO 催化回收。這是國考常考的重要對比。'),
Q('古柯鹼 (Cocaine) 對於單胺類神經遞質的作用機制是？',['抑制受體活化','阻斷回收機制，使突觸間隙內的遞質濃度增加','促進乙醯膽鹼合成','抑制 MAO 的活性'],1,'古柯鹼阻斷 NE、Dopamine 等遞質的回收機制（Reuptake transporter），使其在突觸處持續作用，產生強烈興奮效果。')],
[Q('當人體處於「低溫」(Hypothermia) 狀態時，血紅素對氧的親和力會如何變化？',['下降（曲線右移）','上升（曲線左移），不利於氧氣釋放給組織','不受溫度影響','先升後降'],1,'降低體溫會使曲線「向左移」（親和力上升），Hb 更緊抓氧氣，不利於在組織端釋放氧氣。'),
Q('酸中毒 (Acidosis, pH 下降) 對呼吸生理的直接影響是？',['曲線左移','曲線右移（Bohr Effect）','抑制紅血球代謝','增加血紅素與氧的親和力'],1,'pH 下降（H+ 增加）是 Bohr Effect 的核心，使解離曲線向右移，利於氧氣在組織端釋放。'),
Q('關於波耳效應 (Bohr Effect) 的敘述，何者正確？',['指溫度對溶解度的影響','指 CO2 與 H+ 增加導致 Hb 對氧親和力下降的現象','只發生在肺部氣體交換時','與 DPG 濃度無關'],1,'Bohr effect 描述了酸度 (H+) 與 CO2 增加如何使血紅素對氧的親和力下降（曲線右移），以協助活動組織獲得氧氣。'),
Q('下列何者不屬於兒茶酚胺 (Catecholamines) 類的神經遞質？',['Epinephrine','Norepinephrine','Acetylcholine (ACh)','Dopamine'],2,'Epi、NE、Dopamine 屬於兒茶酚胺（含兒茶酚基的胺類）；ACh 屬於膽鹼類，由 AChE 代謝，不屬此類。'),
Q('高海拔缺氧初期，人體因「過度換氣」產生的酸鹼平衡變化與曲線位移為何？',['呼吸性酸中毒，曲線右移','呼吸性鹼中毒（CO2 排出增加），曲線初期左移','代謝性酸中毒，曲線左移','維持中性，曲線不變'],1,'初到高海拔因缺氧引發過度換氣，排出過多 CO2 導致呼吸性鹼中毒，使曲線初期左移。隨後 2,3-DPG 增加才產生補償性右移。')]
)},
